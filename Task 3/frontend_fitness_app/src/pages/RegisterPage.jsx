  ...
  return (
    <div>
        <form onSubmit={registerUser}>
            ...
            <div className="credentials horizontal-container" style={{ marginTop: "30px" }}>
            ...
            <div className="gender-container radio-btns-container">
            ...
            <div className="body-details horizontal-container">
              <div className="input-field">
